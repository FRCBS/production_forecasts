...
ggplot(master, aes(x = date)) +
  ...
  geom_line(aes(y = smooth(ARIMAX)), color = "red") +
  geom_line(aes(y = linearity), color = "green") +
  geom_line(aes(y = smooth(SNAIVE)), color = "blue") +
  geom_line(aes(y = trend_strength), color = "cyan")
```
