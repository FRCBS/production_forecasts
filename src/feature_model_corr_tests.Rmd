...
end_init <- as.Date("2007-01-01") # segment terminus
...
```{r}
master <- cbind(fhistories, metrics[13:163, ]) %>% select(-c(date, zero_run_mean, zero_start_prop, zero_end_prop, nsdiffs, endyear))
```
