...
These are daily red cell product usage data from each hospital. A red line means a missing data point. The missing data point might just be a zero, which is most probable with RAUMA. Let's limit our explorations to 2019 for now. This probably means we'll have to exclude RAUMA.
