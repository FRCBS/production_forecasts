...
#write.table(save.this, file = "results/histories/monthly_red.csv", sep = ",", row.names = FALSE, col.names = FALSE)
...
# Load history
history <- read.csv("results/histories/monthly_red.csv", header = TRUE)
