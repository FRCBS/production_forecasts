...
# Standard
ets.capes <- find_errors(segment, beginning, series.ts, "ets", smooth = "none")
stl.capes <- find_errors(segment, beginning, series.ts, "stl", smooth = "none")
tbats.capes <- find_errors(segment, beginning, series.ts, "tbats", smooth = "none")
stlf.capes <- find_errors(segment, beginning, series.ts, "stlf", smooth = "none")
lmx2.capes <- find_errors(segment, beginning, series.ts, "tslm", smooth = "none")
naive.capes <- find_errors(segment, beginning, series.ts, "naive", smooth = "none")
snaive.capes <- find_errors(segment, beginning, series.ts, "snaive", smooth = "none")
rwf.capes <- find_errors(segment, beginning, series.ts, "rwf", smooth = "none")
meanf.capes <- find_errors(segment, beginning, series.ts, "meanf", smooth = "none")
# Smooth .25
smthets.capes <- find_errors(segment, beginning, series.ts, "ets", smooth = ".25")
smthstl.capes <- find_errors(segment, beginning, series.ts, "stl", smooth = ".25")
smthtbats.capes <- find_errors(segment, beginning, series.ts, "tbats", smooth = ".25")
smthstlf.capes <- find_errors(segment, beginning, series.ts, "stlf", smooth = ".25")
smthlmx2.capes <- find_errors(segment, beginning, series.ts, "tslm", smooth = ".25")
smthnaive.capes <- find_errors(segment, beginning, series.ts, "naive", smooth = ".25")
smthsnaive.capes <- find_errors(segment, beginning, series.ts, "snaive", smooth = ".25")
smthrwf.capes <- find_errors(segment, beginning, series.ts, "rwf", smooth = ".25")
smthmeanf.capes <- find_errors(segment, beginning, series.ts, "meanf", smooth = ".25")
# Smooth .10
smth10ets.capes <- find_errors(segment, beginning, series.ts, "ets", smooth = ".10")
smth10stl.capes <- find_errors(segment, beginning, series.ts, "stl", smooth = ".10")
smth10tbats.capes <- find_errors(segment, beginning, series.ts, "tbats", smooth = ".10")
smth10stlf.capes <- find_errors(segment, beginning, series.ts, "stlf", smooth = ".10")
smth10lmx2.capes <- find_errors(segment, beginning, series.ts, "tslm", smooth = ".10")
smth10naive.capes <- find_errors(segment, beginning, series.ts, "naive", smooth = ".10")
smth10snaive.capes <- find_errors(segment, beginning, series.ts, "snaive", smooth = ".10")
smth10rwf.capes <- find_errors(segment, beginning, series.ts, "rwf", smooth = ".10")
smth10meanf.capes <- find_errors(segment, beginning, series.ts, "meanf", smooth = ".10")
...
fdf <- chosen_forecast(chosen.model)
...
history$err <- abs((tail(head(monthly_real$red, -1), length(history$forecast)) - history$forecast) / tail(head(monthly_real$red, -1), length(history$forecast))) * 100
...
```{r red_monthly_freqtable, echo = FALSE}
