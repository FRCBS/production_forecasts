...
type <- "red"
save_forecast(fdf, months = TRUE, modelname, monthly, paste0(HISTORYDIR, type, ".csv"), reverse_adj) # Check pffunctions.R
```
...
type <- "plat"
save_forecast(fdf, months = TRUE, modelname, monthly, paste0(HISTORYDIR, type, ".csv"), reverse_adj)
```
...
type <- "red"
draw_history(paste0(HISTORYDIR, type, ".csv"), monthly_real, freq = "monthly", type, palette)
```
