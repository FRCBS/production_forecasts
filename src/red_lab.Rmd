---
title: 'Forecasting Lab: Production Figures (red cells)'
...
Jarno built his forecasts using **STL+ETS** and **ETS** models, including also a naive 6 month repetition forecast. I will not be considering the naive "forecast" here, as I'm fairly certain we want to do proper modelling. Here we will run Jarno's models on business day adjusted data, which will improve their performance somewhat.
```{r}
