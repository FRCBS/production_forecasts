---
title: '[DEPRECATED] Forecasting Lab: Adjusted Production Figures'
output: github_document
---

# Intro

This notebook is exactly the same as **DEP_first_analyses**, but now the an (incorrect) month adjustment has been applied to the series. For contents, refer to the description of **DEP_first_analyses**.
...
```{r}
p1 + theme_bw() + 
  labs(title = "RBC demand through almost two decades",
       x = "Time",
       y = "RBC units")
```
