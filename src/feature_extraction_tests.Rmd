...
# type <- "red"
# 
# # Our data comprises 199 months.
# # Reserving a 3 year moving window, we get 163 months to forecast for.
# N <- length(history$date) - 12 * (rw_years + 1) # Preallocate 163 rows
...
# 
# # Save into a csv
# write.csv(forecast.history, file = "/home/esa/production_forecasts/histories/long_fcast_history.csv", row.names = FALSE)
```
