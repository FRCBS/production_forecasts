...
### Let's test this idea with Trend, Seasonality, and Linearity with 3 year sliding window
...
# feat_df <- data.frame(feature = character(),
#                       value = numeric(), 
#                       until = character(), 
...
```{r}
# Scale for plotting
# TODO: scale(feat_df[which(feat_df[, "feature"] == "trend_strength"), ]$value) et cetera
# Grouped
