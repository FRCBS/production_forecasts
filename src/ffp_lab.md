Forecasting Lab: Production Figures (plasma)
================
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->

``` r
ggseasonplot(ts.ffp, year.labels = TRUE, year.labels.left = TRUE)
```

![](ffp_lab_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
monthly_1yr + ggtitle("STL+ETS forecast of platelet plasma sales month by month, 5 years of data") +
  scale_x_discrete(limits=c(2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018)) + xlab("Time") +
  ylab("Unit sales") + autolayer(window(ts.ffp, start=2008), colour=FALSE)
```

![](ffp_lab_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
# Loop 
for(i in seq(from=48, to=180, by=1)){
  fit <- nnetar(head(ts.ffp, i), lambda=0)  # Fit based on history
  fcast <- forecast(fit, h=1)  # Forecast the next month
  segment <- ts.ffp[i+1]  # Extract that month from the history for error calculation
...
![](ffp_lab_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
|               |     RMSE |     MAPE |
| :------------ | -------: | -------: |
| STL+ETS whole | 13.96510 | 10.29190 |
| ETS whole     | 13.98658 | 10.09158 |
| NN whole      | 12.07180 |  9.31979 |
| STL+ETS 3yr   | 13.75604 | 10.50387 |
| ETS 3yr       | 13.87341 | 10.31024 |
| STL+ETS 1yr   | 14.63149 | 11.05275 |
| ETS 1yr       | 14.23221 | 10.50066 |
| STL+ETS 2012  | 13.66439 | 10.43797 |
