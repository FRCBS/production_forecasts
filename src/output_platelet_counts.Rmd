...
---
```{r setup, echo = FALSE}
#echo "rmarkdown::render('output_platelet_counts.Rmd', clean=TRUE,output_file='../results/output_platelet_counts.20200324.html')" | R --slave 
...
Looks OK. 
```{r}
file <- "../results/20200324DailyCountsOfPlateletReturnsAndDeliveries.txt"
