...
#echo "rmarkdown::render('output_platelet_counts.Rmd', clean=TRUE,output_file='../results/output_platelet_counts.20200312.html')" | R --slave 
...
Looks a bit funny, but it could do?