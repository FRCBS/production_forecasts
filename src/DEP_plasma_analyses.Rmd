...
Old forecasts are built using **STL+ETS** and **ETS** models, including also a naive 6 month repetition forecast. I will not be considering the naive "forecast" here, as I'm fairly certain we want to do proper modelling. 
```{r old_forecasts}
