...
#.libPaths("packrat/lib/x86_64-pc-linux-gnu/3.6.1/")

source("~/forecaster-investigations/src/report_functions_internal.R") # source our own helper functions
...
<center>Ajettu viimeksi: `r now()`</center>
...
```{r RBC_ECON_FIX_expl, echo = FALSE, results = 'asis', eval = RBC & FIX & ECON, message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```

```{r RBC_ECON_acc_expl, echo = FALSE, results = 'asis', eval = RBC & ECON, message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Virheprosentti lasketaan 2 vuoden kuukausisumman ennustustarkkuudesta.</center>")
```

```{r RBC_ECON_LASTYEAR_title, echo = FALSE, results = 'asis', eval = RBC & ECON, message = FALSE, warning = FALSE}
cat("
***
  <style>
...
```{r RBC_ECON_LASTYEAR_table, R.options = list(width = 100), echo = FALSE, eval = RBC & ECON, message = FALSE, warning = FALSE}
table_previous_year(data, PROD)
```
...
```{r PLAT_ECON_FIX_expl, echo = FALSE, results = 'asis', eval = PLAT & FIX & ECON, message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r PLAT_ECON_LASTYEAR_title, echo = FALSE, results = 'asis', eval = PLAT & ECON, message = FALSE, warning = FALSE}
cat("
***
  <style>
div.tabtitle { font-size: 25px; text-align: center; margin: auto;}
...
```{r PLAT_ECON_LASTYEAR_table, R.options = list(width = 100), echo = FALSE, eval = PLAT & ECON, message = FALSE, warning = FALSE}
table_previous_year(data, PROD)
```
...
```{r RBC_FIX_expl, echo = FALSE, results = 'asis', eval = RBC & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r PLAT_FIX_expl, echo = FALSE, results = 'asis', eval = PLAT & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r O+_FIX_expl, echo = FALSE, results = 'asis', eval = OPLUS & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r O-_FIX_expl, echo = FALSE, results = 'asis', eval = OMINUS & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r A+_FIX_expl, echo = FALSE, results = 'asis', eval = APLUS & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r A-_FIX_expl, echo = FALSE, results = 'asis', eval = AMINUS & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r B+_FIX_expl, echo = FALSE, results = 'asis', eval = BPLUS & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r B-_FIX_expl, echo = FALSE, results = 'asis', eval = BMINUS & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r AB+_FIX_expl, echo = FALSE, results = 'asis', eval = ABPLUS & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
```{r AB-_FIX_expl, echo = FALSE, results = 'asis', eval = ABMINUS & FIX & !(ECON), message = FALSE, warning = FALSE}
cat("<center style='font-size:8pt'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
...
Kaavion alapuolella esitetään taulukkomuodossa toteuma ja ennusteet kuluvalle vuodelle. ECON-tasolla tuotetaan myös kolme muuta taulukkoa: viime vuoden toteuma, ennusteet ja ennusteiden virheet, sekä 5 vuoden vuosiennusteet ja trendit myynneille ja palautuksille erikseen. Taulukoiden tiedot voidaan kopioida suoraan leikepöydälle painikkeesta "Copy", tallentaa Excel-tiedostoksi ("Excel"), CSV-tiedostoksi ("CSV") ja PDF-tiedostoksi ("PDF").
...
Viikkoennusteita varten rakennetaan viikkosarja, mutta tällaista säätöä ei tehdä, sillä viikot ovat kaikki 7 päivää.
