...
if (!file.exists(sales_method_history_path)) { generate_method_history(data, S_R = "S", PROD, RES, ECON, TRAIN_LEN, HORIZON, OUTPUT, ECON_ALT = TRUE) }
if (!file.exists(returns_method_history_path)) { generate_method_history(data, S_R = "R", PROD, RES, ECON, TRAIN_LEN, HORIZON, OUTPUT, ECON_ALT = TRUE) }
