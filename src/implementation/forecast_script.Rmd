...
cat("<center style='font-size:1vw'>Dataa on korvattu 2020 kevään osalta (maalis-kesä, 2019 kevään datalla) COVID-pandemian aiheuttamien poikkeusolojen ja joidenkin datansyöttövirheiden takia.</center>")
```
