---
title: "Benchmarking Lab: Red Cells"
...
Unfortunately this seems to be even worse. Might be due to differences in how auto.arima() and tslm() find their best models, but I am not sure.